<template>
    <div class="count-summary">
      <div class="search-wrapper">
            ...
            <div class="search-item" v-show="type == 1 || type == 2 || type == 3">
                <label>考核日期：</label>
            ...
            <el-row class="button-wrapper">
              <el-button type="primary" size="mini" @click="getData()" v-show="type !== 7">查询</el-button>
              <el-button type="primary" size="mini" @click="getSumData()" v-show="type == 7">查询</el-button>
              <el-button type="primary" plain size="mini" @click="exportTable()">导出</el-button>
            </el-row>
        </div>

        <div>
          <el-table border size="mini" :data="tableData" style="width: 100%" :default-sort = "{prop: 'totalScore', order: 'descending'}" v-loading="loading" v-show="type !== 7">
            <el-table-column type="index" width="50"></el-table-column>
            <el-table-column v-if="type == 1 || type == 4" prop="groupType" label="职务级别" width="240"></el-table-column>
            <el-table-column v-if="type == 2 || type == 5" prop="groupType" label="公司/业务单元" width="240"></el-table-column>
            <el-table-column v-if="type == 3 || type == 6" prop="lv1" label="公司" width="180" ></el-table-column>
            ...
            <el-table-column v-if="type == 3 || type == 6" prop="groupType" label="一级部门" width="240"></el-table-column>
            <el-table-column v-if="type == 4 || type == 5 || type == 6" prop="NUM" label="总人数" width="80"></el-table-column>
            <el-table-column v-if="type == 4 || type == 5 || type == 6" prop="avg" label="人均加分" sortable width="100"></el-table-column>
            <el-table-column v-if="type == 4 || type == 5 || type == 6" prop="percent" label="人均加分率" sortable></el-table-column>
          </el-table>

          <!-- 人员排名 -->
           <el-table :data="data" stripe height="400" style="margin-top: 20px" v-loading="loading" size="mini" :default-sort = "{prop: '总累计积分', order: 'descending'}" v-show="type == 7">
...
export default {
  ...
  methods: {
    ...
    getData () {
      let type = this.type
      type = type == 4?1:type == 5?2:type == 6?3:type == 7?4:type
